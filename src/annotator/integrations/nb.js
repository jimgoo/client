 ...
 */
export class NBIntegration extends TinyEmitter {
  /**
  ...
  async uri() {
    const uri = new URL(this._htmlMeta.uri());
    console.info("original uri: ", uri.toString());
    uri.search = '';
    console.info("new uri: ", uri.toString());
